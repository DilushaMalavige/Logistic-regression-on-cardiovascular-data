...
-   Best Model
    ...
    TenYearCHD \~ sexM + prevalentStroke1 + age + cigsPerDay + totChol + sysBP + glucose
...
```{r}
#split dataset in to train and test by 80% to train data and 20 % to test data
set.seed(123)
...
-   The proposed logistic regression model has 88% accuracy.
